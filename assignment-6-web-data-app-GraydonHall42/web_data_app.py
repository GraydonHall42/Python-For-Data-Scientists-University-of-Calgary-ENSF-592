...
def book_data():
    ...
    for book in book_results:
        titles.append(book.h3.a.get('title'))  # get book title
        prices.append(float(book.find('p', class_="price_color").text[1:]))  # get price of book... omit first index (cut off currency symbol)
...
def learn():
    ...
    return "I've learned that data science is fun and that I'm excited to be a software engineer!"
